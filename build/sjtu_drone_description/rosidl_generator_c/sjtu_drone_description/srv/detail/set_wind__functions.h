...
#ifndef SJTU_DRONE_DESCRIPTION__SRV__DETAIL__SET_WIND__FUNCTIONS_H_
#define SJTU_DRONE_DESCRIPTION__SRV__DETAIL__SET_WIND__FUNCTIONS_H_
...
#include "sjtu_drone_description/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_sjtu_drone_description
bool
 ...
 * calls
 * sjtu_drone_description__srv__SetWind_Request__init().
...
/**
 * It calls
 * sjtu_drone_description__srv__SetWind_Request__fini()
 ...
 * sjtu_drone_description__srv__SetWind_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * sjtu_drone_description__srv__SetWind_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sjtu_drone_description__srv__SetWind_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sjtu_drone_description
...
/**
 * It calls
 * sjtu_drone_description__srv__SetWind_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sjtu_drone_description
...
/**
 * It allocates the memory for the array and calls
 * sjtu_drone_description__srv__SetWind_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sjtu_drone_description
...
/**
 * It calls
 * sjtu_drone_description__srv__SetWind_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SJTU_DRONE_DESCRIPTION__SRV__DETAIL__SET_WIND__FUNCTIONS_H_
