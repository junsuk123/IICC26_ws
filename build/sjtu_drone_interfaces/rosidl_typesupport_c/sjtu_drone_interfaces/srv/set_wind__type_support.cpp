...
static const _SetWind_Request_type_support_symbol_names_t _SetWind_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sjtu_drone_interfaces, srv, SetWind_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sjtu_drone_interfaces, srv, SetWind_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sjtu_drone_interfaces, srv, SetWind_Request)() {
  return &::sjtu_drone_interfaces::srv::rosidl_typesupport_c::SetWind_Request_message_type_support_handle;
}
...
static const _SetWind_Response_type_support_symbol_names_t _SetWind_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sjtu_drone_interfaces, srv, SetWind_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sjtu_drone_interfaces, srv, SetWind_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sjtu_drone_interfaces, srv, SetWind_Response)() {
  return &::sjtu_drone_interfaces::srv::rosidl_typesupport_c::SetWind_Response_message_type_support_handle;
}
...
static const _SetWind_type_support_symbol_names_t _SetWind_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sjtu_drone_interfaces, srv, SetWind)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sjtu_drone_interfaces, srv, SetWind)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, sjtu_drone_interfaces, srv, SetWind)() {
  return &::sjtu_drone_interfaces::srv::rosidl_typesupport_c::SetWind_service_type_support_handle;
}
