...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/j/INCSL/IICC26_ws/install/sjtu_drone_control"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/sjtu_drone_control/hook/path.sh"
