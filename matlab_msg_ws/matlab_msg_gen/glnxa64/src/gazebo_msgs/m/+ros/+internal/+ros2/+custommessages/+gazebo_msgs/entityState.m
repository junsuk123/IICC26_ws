function [data, info] = entityState
%EntityState gives an empty data for gazebo_msgs/EntityState
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'gazebo_msgs/EntityState';
...
info.MessageType = 'gazebo_msgs/EntityState';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
