...
%SpawnEntity gives an empty data for gazebo_msgs/SpawnEntityResponse
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'gazebo_msgs/SpawnEntityResponse';
...
info.MessageType = 'gazebo_msgs/SpawnEntityResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
