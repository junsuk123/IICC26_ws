...
// Common copy functions for gazebo_msgs/WorldState
#ifdef _MSC_VER
#pragma warning(push)
...
class GAZEBO_MSGS_EXPORT ros2_gazebo_msgs_msg_WorldState_common : public MATLABROS2MsgInterface<gazebo_msgs::msg::WorldState> {
  public:
    virtual ~ros2_gazebo_msgs_msg_WorldState_common(){}
    virtual void copy_from_struct(gazebo_msgs::msg::WorldState* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const gazebo_msgs::msg::WorldState* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_gazebo_msgs_msg_WorldState_common::copy_from_struct(gazebo_msgs::msg::WorldState* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_gazebo_msgs_msg_WorldState_common::get_arr(MDFactory_T& factory, const gazebo_msgs::msg::WorldState* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","header","name","pose","twist","wrench"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("gazebo_msgs/WorldState");
    // header
...
class GAZEBO_MSGS_EXPORT ros2_gazebo_msgs_WorldState_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_gazebo_msgs_WorldState_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_gazebo_msgs_WorldState_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<gazebo_msgs::msg::WorldState,ros2_gazebo_msgs_msg_WorldState_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_gazebo_msgs_WorldState_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<gazebo_msgs::msg::WorldState,ros2_gazebo_msgs_msg_WorldState_common>>();
  }
  std::shared_ptr<void> ros2_gazebo_msgs_WorldState_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<gazebo_msgs::msg::WorldState>();
    ros2_gazebo_msgs_msg_WorldState_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_gazebo_msgs_WorldState_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_gazebo_msgs_msg_WorldState_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (gazebo_msgs::msg::WorldState*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_gazebo_msgs_msg_WorldState_common, MATLABROS2MsgInterface<gazebo_msgs::msg::WorldState>)
CLASS_LOADER_REGISTER_CLASS(ros2_gazebo_msgs_WorldState_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
