%% RunPaperPlotsWithDegradedBaseline.m
% Regenerate paper plots using 10000-sample validation data with degraded baseline
...
fprintf('[RunPaperPlotsWithDegradedBaseline] Starting paper plots regeneration...\n');
fprintf('[RunPaperPlotsWithDegradedBaseline] Using validation data from: %s\n', paperPlotRunDir);
