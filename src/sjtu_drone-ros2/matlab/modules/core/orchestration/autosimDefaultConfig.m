function cfg = autosimDefaultConfig()
    ...
    cfg.wind.kma_pick_mode = "random_start_cycle"; % "random_start_cycle" | "sequential" | "random"
    ...
    cfg.ontology.wind_risk_model.c_y = nan;
    cfg.ontology.wind_risk_model.S_x = nan;
    cfg.ontology.wind_risk_model.S_y = nan;
    cfg.ontology.wind_risk_model.c_min = 0.2;
    cfg.ontology.wind_risk_model.F_min = 0.5;
    cfg.ontology.wind_risk_model.a_thr = 1.2;
    cfg.ontology.wind_risk_model.w_body = 0.7;
    cfg.ontology.wind_risk_model.w_gust = 0.3;
    cfg.ontology.wind_risk_model.theta_thr_rad = pi;
