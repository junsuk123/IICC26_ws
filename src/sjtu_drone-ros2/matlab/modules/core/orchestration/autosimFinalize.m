...
function finalTbl = autosimBuildFinalDatasetTable(summaryTbl)
    ...
    wanted = { ...
        ...
        'wind_body_force_x','wind_body_force_y','wind_body_force', ...
        'mean_wind_body_risk','mean_wind_gust_risk','mean_wind_risk_raw','min_thrust_margin_n', ...
        'mean_estimation_uncertainty','gps_dropout_enabled','gps_dropout_start_sec','gps_dropout_duration_sec', ...
        'moving_pad_enabled','moving_pad_amp_u','moving_pad_amp_v','moving_pad_freq_hz', ...
