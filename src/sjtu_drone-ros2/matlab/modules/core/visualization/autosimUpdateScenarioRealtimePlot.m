function autosimUpdateScenarioRealtimePlot(viz, state)
    ...
    try
        ...
        sensorVals = [ ...
            ...
            autosimClampNaN(autosimVizField(sensors, 'estimationUncertainty', nan), 0.0) ...
        ];
        ...
        sensorStateLabels = {
            ...
            autosimVizLevelText(sensorVals(9), {'confident','warn','uncertain'}) ...
        };
        ...
        relWindControl = autosimClampNaN(autosimVizField(semantic, 'relation_wind_control', windRiskScore), nan);
        relVisualAlign = autosimClampNaN(autosimVizField(semantic, 'relation_visual_alignment', alignScore), nan);
        relEstConflict = autosimClampNaN(autosimVizField(semantic, 'relation_estimation_conflict', autosimVizField(sensors, 'estimationUncertainty', nan)), nan);
        ...
        conceptVals = [ ...
            autosimClampNaN(relWindControl, 0.0), ...
            autosimClampNaN(relVisualAlign, 0.0), ...
            autosimClampNaN(relEstConflict, 0.0), ...
            autosimClampNaN(safetyScore, 0.0), ...
            autosimClampNaN(feasibilityScore, 0.0) ...
        ];
        set(viz.conceptBar, 'YData', conceptVals);
        conceptStateLabels = {
            autosimVizLevelText(conceptVals(1), {'low','mid','high'}), ...
            autosimVizLevelText(conceptVals(2), {'weak','mid','strong'}), ...
            autosimVizLevelText(conceptVals(3), {'low','mid','high'}), ...
            autosimVizCompactToken(string(autosimVizField(semantic, 'semantic_relation', autosimVizField(semantic, 'final_decision', "unknown")))), ...
        ...
        flowLines = [ ...
            ...
            string(sprintf('unc=%.2f | relW=%.2f relV=%.2f relE=%.2f', ...
                autosimVizField(sensors, 'estimationUncertainty', nan), ...
                autosimVizField(semantic, 'relation_wind_control', nan), ...
                autosimVizField(semantic, 'relation_visual_alignment', nan), ...
                autosimVizField(semantic, 'relation_estimation_conflict', nan))); ...
            string(sprintf('gps_dropout=%d | padOff=(%.3f, %.3f)', ...
                round(autosimVizField(sensors, 'gpsDropoutActive', 0)), ...
                autosimVizField(sensors, 'movingPadOffsetU', 0.0), autosimVizField(sensors, 'movingPadOffsetV', 0.0))); ...
